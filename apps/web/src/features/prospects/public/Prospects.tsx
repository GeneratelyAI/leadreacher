...
import { Filter as VisualFilter, type FilterGroup } from "@/components/patterns/Filter";
...
const Importer = dynamic(
  () => import("@/features/prospects/public/Importer").then((module) => module.Importer),
  { ssr: false, loading: () => null },
);
const AddProspect = dynamic(
  () => import("@/features/prospects/public/AddProspect").then((module) => module.AddProspect),
  { ssr: false, loading: () => null },
);
const Finder = dynamic(
  () => import("@/features/prospects/public/Finder").then((module) => module.Finder),
  { ssr: false, loading: () => null },
);
