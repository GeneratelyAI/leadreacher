...
import { channelDisplayName } from "@/features/channels/public/Channel";
import type { OutreachChannel, SequenceStep, SequenceStepType } from "@leadreacher/shared/delivery";

export type SequenceStepDraft = SequenceStep;
...
] as const satisfies readonly { value: SequenceStepType; label: string; channel: OutreachChannel }[];
