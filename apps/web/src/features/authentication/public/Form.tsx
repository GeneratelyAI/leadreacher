...
import Brand from "@/features/authentication/components/Brand";
import Mobile from "@/features/authentication/components/Mobile";
...
export default function Form({ mode, demo = false, onDemoComplete }: FormProps) {
  const {
    email,
    setEmail,
    password,
  ...
  return (
    <>
      <div className="lg:hidden">
        <Mobile mode={mode} demo={demo} onDemoComplete={onDemoComplete} />
      </div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  {isSignup ? <PasswordRules password={password} /> : null}
                  {!isSignup ? (
