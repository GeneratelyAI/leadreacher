...
import type { AuthCampaignFormState } from "./auth-campaign-types";
      ...
      <section className={cn("signup-campaign-form-column", styles.column)} aria-labelledby="login-campaign-title">
        ...
        <div className={cn("signup-campaign-auth-actions", styles.actions)}>
          ...
          <form className={cn("space-y-3", styles.form)} onSubmit={handleEmailSubmit}>
            ...
            <div className={cn("login-campaign-forgot", styles.forgot)}><Link href="/forgot-password">Forgot password?</Link></div>
          ...
          <p className={cn("signup-campaign-login", styles.switchAccount)}>New to LeadReacher? <Link href={preview ? "/onboarding-preview?screen=01" : "/signup"}><span className={styles.desktopOnly}>Start your first campaign</span><span className={styles.mobileOnly}>Create an account</span></Link></p>
        </div>
      </section>
