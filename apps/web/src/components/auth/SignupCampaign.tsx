    ...
    <div data-testid="signup-campaign-auth" className={cn("signup-campaign-layout", styles.layout)}>
      <section className={cn("signup-campaign-form-column", styles.column)} aria-labelledby="signup-campaign-title">
        ...
        <div className={cn("signup-campaign-auth-actions", styles.actions)}>
          ...
          <p className={styles.legal}>By creating an account, you agree to our <Link href="/terms">Terms of Service</Link> and <Link href="/privacy">Privacy Policy.</Link></p>
          <p className={cn("signup-campaign-login", styles.switchAccount)}>Already have an account? <Link href={preview ? "/onboarding-preview?screen=02" : "/login"}>Sign in</Link></p>
        </div>
