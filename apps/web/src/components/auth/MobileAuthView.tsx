...
const inputClassName = cn(
  "w-full rounded-xl border-0 bg-white px-4 py-3.5 text-[15px] text-neutral-900 shadow-sm",
...
const oauthButtonClassName = cn(
  "flex flex-1 items-center justify-center gap-2 rounded-xl border border-gray-200/80 bg-white",
  "px-3 py-3 text-sm font-medium text-neutral-800 shadow-sm active:bg-neutral-50",
);
...
export default function MobileAuthView({ mode }: MobileAuthViewProps) {
  ...
  return (
    <div className="relative mx-auto min-h-dvh w-full max-w-[430px] pb-8">
      <div className="flex flex-col items-center px-4 pt-10">
        ...
        <h1 className="text-center text-[28px] leading-tight font-bold tracking-tight text-[#111827]">
        ...
        <p className="mt-3 max-w-[280px] text-center text-sm leading-relaxed text-neutral-500">
          {copy.subtext}
        </p>

        <div className="mt-6 flex w-full max-w-sm items-center gap-3">
          <div className="h-px flex-1 bg-neutral-300/80" />
          <div className="flex shrink-0 items-center gap-2 text-[13px] text-[#5e5870]">
            <ShieldCheck
            ...
            <Fragment key={step.key}>
              {index > 0 ? (
                <div className="flex h-12 items-center">
                  <ArrowRight
                    className="size-4 shrink-0 text-[#c4b8d8]"
                    strokeWidth={1.75}
                    aria-hidden
                  />
                </div>
              ...
              <div className="flex flex-col items-center gap-2">
                <span
                  className="inline-flex size-12 items-center justify-center rounded-xl bg-[#ede8f7]"
                  aria-hidden
                >
                  {(() => {
                ...
                <span className="text-xs font-medium text-[#5e5870]">
                  {step.label}
                </span>
              </div>
            </Fragment>
        ...
        <div className="mt-8 w-full">
          ...
          <form className="space-y-4" onSubmit={handleEmailSubmit}>
            <div className="space-y-2 rounded-2xl bg-[#e8e8ee] p-2">
              {copy.showFullName ? (
                <div className="relative">
                  ...
                  />
                  <User
                    className="pointer-events-none absolute top-1/2 right-4 size-4 -translate-y-1/2 text-neutral-400"
                    aria-hidden
                  />
                </div>
              ) : null}
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-1/2 right-4 -translate-y-1/2 rounded-md p-0.5 text-neutral-400 transition-colors hover:text-neutral-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5326b7]/30"
            ...
            {error ? (
              <p className="rounded-xl bg-red-50 px-3 py-2.5 text-xs text-red-700 ring-1 ring-red-100">
                {error}
              </p>
            ) : null}
