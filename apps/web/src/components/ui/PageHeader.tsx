...
export function PageHeader({
  ...
  return (
    <header className={cn("flex max-w-2xl flex-col", alignment, className)} {...props}>
      ...
      <h1 className="mt-4 text-3xl font-bold tracking-tight text-onboarding-ink sm:text-4xl dark:text-onboarding-neutral-0">
        {title}
      </h1>
