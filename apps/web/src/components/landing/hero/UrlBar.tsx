  ...
  return (
    <form ref={formRef} data-fiber-flow-target={formRef ? true : undefined} onSubmit={onSubmit} className={formClassName} style={formStyle} noValidate>
      <div
        ...
        className="hero-analyzer flex min-h-18 items-center rounded-[22px] border border-transparent p-1.5 shadow-[0_18px_45px_rgba(66,42,148,0.10)] transition-[box-shadow] duration-300 focus-within:shadow-[0_18px_45px_rgba(66,42,148,0.16),0_0_0_3px_rgba(124,58,237,0.10),0_0_30px_rgba(99,102,241,0.14)] sm:min-h-20 sm:p-2"
        style={{
