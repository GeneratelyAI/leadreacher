  ...
  return (
    <section className="relative isolate flex min-h-screen w-full flex-col overflow-hidden pb-0">
      ...
      <div
        ...
        aria-hidden
      />
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col items-center px-5 pb-16 pt-9 sm:px-8 sm:pb-20 sm:pt-12">
        <header className="mb-6 flex justify-center sm:mb-7">
          <Logo size="md" />
        </header>
        <main className="flex flex-1 flex-col items-center justify-center text-center">
          <div className="relative flex w-full max-w-6xl flex-col items-center justify-center px-2 pt-2 pb-10 sm:px-4 sm:pt-3 sm:pb-14 md:min-h-[40vh] lg:min-h-[42vh]">
