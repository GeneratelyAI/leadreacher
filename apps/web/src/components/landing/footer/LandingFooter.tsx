...
const FOOTER_CONTENT_CLASS =
  "mx-auto w-full max-w-[90rem] px-6 sm:px-10 lg:px-14 xl:px-20";
const FOOTER_DIVIDER_CLASS =
  "pointer-events-none mb-12 h-[0.5px] w-full bg-[#69597b]/75 sm:mb-14";
const FOOTER_GRID_CLASS =
  "grid w-full gap-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-[minmax(0,2fr)_repeat(4,minmax(0,1fr))] lg:gap-x-16 lg:gap-y-12 xl:gap-x-24";
        ...
        <div className={FOOTER_CONTENT_CLASS}>
          ...
          <div className={FOOTER_GRID_CLASS}>
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="mt-5 max-w-xl text-base leading-relaxed text-footer-text lg:max-w-2xl">
                {FOOTER_TAGLINE}
              </p>
              <div className="mt-6">
                <FooterSocialLinks />
