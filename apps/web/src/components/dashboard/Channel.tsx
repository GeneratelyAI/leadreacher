...
import { ChannelLogo as Mark, type ChannelLogoName } from "@/components/onboarding/ChannelLogo";
...
export function PlatformLogo({
  ...
  const logo = channelLogoName(platform, accountName);
  if (logo) return <Mark name={logo} className={cn("size-5 shrink-0", className)} />;
