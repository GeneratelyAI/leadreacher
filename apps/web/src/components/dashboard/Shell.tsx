...
const ShellContext = createContext<{ memberName: string; canExportData: boolean } | null>(null);

export function useShell() {
  const context = useContext(ShellContext);
  if (!context) throw new Error("useShell must be used within Shell");
  return context;
}
...
export function Shell({
  ...
  return (
    <TooltipProvider>
      ...
      >
      <ShellContext.Provider value={{ memberName, canExportData }}>
