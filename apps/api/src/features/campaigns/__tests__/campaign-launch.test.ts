...
vi.mock("../public/campaign-step0-queue.js", () => ({ ensureCampaignStepZeroQueued }));
vi.mock("../public/campaign-channel-accounts.js", () => ({ resolveAndSyncCampaignChannelAccounts }));
vi.mock("../public/campaign-relationship-routing.js", () => ({ getCampaignRelationshipSummary }));
vi.mock("../public/campaign-sequence-control.js", () => ({ cancelCampaignPendingSequenceJobs }));
vi.mock("../../billing/public/entitlements.js", () => ({ requireOrganizationEntitlement }));
vi.mock("../../../lib/dashboard-cache.js", () => ({ invalidateDashboardChrome }));
vi.mock("../../channels/public/instagram-identity-resolution.js", () => ({
  resolveInstagramCampaignIdentities,
}));

import { launchCampaign } from "../public/campaign-launch.js";
