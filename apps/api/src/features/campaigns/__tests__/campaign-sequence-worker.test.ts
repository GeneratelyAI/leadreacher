...
vi.mock("../public/campaign-step1-chat.js", () => ({
  deliverSequenceStep1ViaChat,
}));
vi.mock("../../billing/public/entitlements.js", () => ({
...
vi.mock("../../content/public/campaign-video.js", () => ({
  ensureCampaignVideoReady,
}));
vi.mock("../../messages/public/delivery-attempt.js", () => ({
  acquireDeliveryReservation,
  markDeliveryReservationUnknown,
}));
vi.mock("../public/campaign-channel-accounts.js", () => ({
...
import { startCampaignSequenceWorker } from "../public/campaign-sequence-worker.js";
