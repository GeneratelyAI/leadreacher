...
vi.mock("../../../platform/providers/google-tts.js", () => ({ synthesizeSpeech: vi.fn() }));
vi.mock("../../../platform/providers/r2.js", () => ({ R2Adapter: class {} }));
vi.mock("../../../platform/media/video-frames.js", () => ({ composePersonalizedVideo: vi.fn() }));

import {
  ensureCampaignVideoReady,
  ensurePersonalizedVideoReady,
} from "../public/campaign-video.js";
