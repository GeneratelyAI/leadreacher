...
} from "../../onboarding/public/discovery-routes.js";
...
export async function bootstrapUserOrganization({ name, accountType, anonScrapeId, supabaseId, email }: {
  name: string;
  ...
  return { ...result, scrapeStatus, ...onboardingProgress };
}
