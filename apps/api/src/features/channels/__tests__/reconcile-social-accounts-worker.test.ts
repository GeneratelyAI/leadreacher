...
vi.mock("../../../platform/providers/unipile.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../../platform/providers/unipile.js")>();
  return {
    ...actual,
...
import { reconcileSocialAccountStatuses } from "../public/reconcile-social-accounts-worker.js";
