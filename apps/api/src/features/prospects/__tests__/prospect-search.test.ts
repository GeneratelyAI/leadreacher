...
vi.mock("../../../platform/providers/unipile-prospect-search.js", () => ({
  UnipileProspectSearchProvider: class {
    searchPeople = searchPeople;
  },
}));
vi.mock("../public/lead-import.js", () => ({ importProspectProfiles }));

import { searchAndImportLinkedInProspects } from "../public/prospect-search.js";
