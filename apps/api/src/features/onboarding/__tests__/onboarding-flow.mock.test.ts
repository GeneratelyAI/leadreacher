...
vi.mock("../../../platform/providers/stripe.js", () => ({
  getStripePrice,
...
vi.mock("../../campaigns/public/campaign-step1-chat.js", () => ({
  deliverSequenceStep1ViaChat: vi.fn(),
}));
vi.mock("../../campaigns/public/campaign-launch.js", () => ({ launchCampaign }));
vi.mock("../../prospects/public/prospect-search.js", () => ({ searchAndImportLinkedInProspects }));
vi.mock("../../../platform/providers/unipile.js", () => ({
...
import { billingRoutes } from "../../billing/public/routes.js";
import { onboardingRoutes } from "../public/onboarding-routes.js";
import { socialAccountRoutes } from "../../channels/public/social-accounts-routes.js";
import { strategyRoutes } from "../public/strategy-routes.js";
import { stripeWebhookRoutes } from "../../billing/public/webhook.js";
import { webhookRoutes } from "../../channels/public/webhooks-routes.js";
