...
Check: advertiser-relevant professional spokesperson and authentic industry setting; silent first 1.5 seconds reserved for a later greeting, with a closed or minimally moving mouth; no recipient-specific language; credible 14-18 word shared narration; consistent spokesperson, setting, lighting, and style; smooth theme-relevant camera transition; exact supplied-logo-only ending from 8.5-10 seconds; no additional text, data, numbers, graphics, logos, invented claims, or branding. Pass at 7 or higher. Output only {"score": number, "feedback": string[]}.`;
